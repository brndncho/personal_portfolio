        ...
        <section id="home" className="min-h-screen flex items-center justify-center relative">
            <RevealOnScroll>
                <div className="text-center z-10 px-4">
                    <h1 className="text-5xl md:text-7xl font-bold mb-6 leading-right bg-gradient-to-r from-blue-500 to-cyan-600 bg-clip-text text-transparent">
                        Hi, I'm Brandon
                    </h1>

                    <p className="text-grey-400 text-lg mb-8 max-w-lg mx-auto">
                        I'm a computing science student at Simon Fraser University with a passion for coding.
                        My goal is to create software that is both functional and user-friendly.
